...
$vendor_name= isset($get->vendor_name)?$get->vendor_name:"";
...
if(!empty($queryshould))
	$search['body']['query']['bool']['must'][]['bool']['should'] = $queryshould;
if(!empty($categoryShould))
	$search['body']['query']['bool']['must'][]['bool']['should'] = $categoryShould;
