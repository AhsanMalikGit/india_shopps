...
if(!empty($filter_agg))
{
	...
	{
	$search['body']['aggs']['cat_id_aggr'] = array( 'aggs' => array(														
														'vendor_name' => array(
															'terms' => array(
																'field' => 'vendor_name',
																'size'	=>	0
		...
		$search['body']['aggs']['cat_id_aggr']['filter'] = $filter_agg['cat_id_aggr'];
	}
if(!empty($filter_agg['type_aggr']))
	{
	$search['body']['aggs']['type_aggr'] = array( 'aggs' => array(
														'category' => array(
															'terms' => array(
																'field' => 'category',
																'size'	=>	0
		...
		$search['body']['aggs']['type_aggr']['filter'] = $filter_agg['type_aggr'];
	}
