...
//$filter_cat			= isset($get->filter_cat)?$get->filter_cat:351;
...
{				
	...
	//$srchShould[] = array('match' => array('name' => array('query' => $productInfo,'operator' => 'or')));		
	//$must[] = array('match' => array('name' => array('query' => $productInfo,'operator' => 'and')));	
	
	
	$srchShould[] = array('match' => array('name' => array('query' => $productInfo,'operator' => 'or','boost' => '6')));
//	$srchShould[] = array('match' => array('category' => array('query' => $productInfo,'operator' => 'or','boost' => '7')));
//	$srchShould[] = array('match' => array('brand' => array('query' => $productInfo,'operator' => 'or','boost' => '5')));
...
$search['body']['query']['function_score']['query']['filtered']['query']['bool']['must'] = $must;
if(!empty($catShould))
	$search['body']['query']['function_score']['query']['filtered']['query']['bool']['must'][]['bool']['should'] = $catShould;
if(!empty($cat_idShould))
	$search['body']['query']['function_score']['query']['filtered']['query']['bool']['must'][]['bool']['should'] = $cat_idShould;
if(!empty($vendShould))
	$search['body']['query']['function_score']['query']['filtered']['query']['bool']['must'][]['bool']['should'] = $vendShould;
if(!empty($brandShould))
	$search['body']['query']['function_score']['query']['filtered']['query']['bool']['must'][]['bool']['should'] = $brandShould;
if(!empty($grpShould))
	$search['body']['query']['function_score']['query']['filtered']['query']['bool']['must'][]['bool']['should'] = $grpShould;
if(!empty($srchShould))
	$search['body']['query']['function_score']['query']['filtered']['query']['bool']['must'][]['bool']['should'] = $srchShould;


//$search['body']['query']['function_score']['random_score']['seed'] = time();
//$search['body']['query']['function_score']['query']['filtered']['filter'] = array (array ('term' => array('category_id'=>$filter_cat)));
//$search['body']['query']['function_score']['query']['filtered']['filter'] = array (array ('term' => array('vendor'=>0)));
