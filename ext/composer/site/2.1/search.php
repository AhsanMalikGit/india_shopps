...
$parent_category	= isset($get->parent_category)?strtolower($get->parent_category):"";
...
if($cat_id	== 365)
	$brand_min_doc_count= isset($get->brand_min_doc_count)?$get->brand_min_doc_count:1;
else
...
if(!empty($parent_category)){
	...
	$must[] = array('match' => array('parent_category' => $parent_category));	
