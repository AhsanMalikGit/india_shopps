...
<!--========================Banners=====================-->
			<div class="cate_image_bg col-md-6 col-sm-6 col-xs-12">
				<a href="/redirect?url=http%3A%2F%2Fwww.flipkart.com%2Fiphone-7%3Faffid%3Daffiliate7" target="_blank">
					<img src="<?=asset("/images/v1/banners/banner_86.jpg")?>" alt="dDiwali Offers" class="img-responsive lazy" />
				</a>
			</div>
			<div class="cate_image_bg col-md-6 col-sm-6 col-xs-12">
				<a href="http://www.indiashopps.com/amazon-great-indian-festival-sale" target="_blank">
					<img src="<?=asset("/images/v1/banners/banner_90.jpg")?>" alt="Festive and Party looks" class="img-responsive lazy" />
				</a>
			</div>
<!------========================Top Brand==============- -->
            <div class="col-xs-12">
...
<!--========================Banners=====================-->                 
			<div class="cate_image_bg col-md-6 col-sm-6 col-xs-12">
				<a href="/redirect?url=http%3A%2F%2Fwww.amazon.in%2Fb%3Fie%3DUTF8%26node%3D11416909031%26tag%3Dindiashopps-21" target="_blank">
					<img src="<?=asset("/images/v1/banners/banner_88.jpg")?>" alt="Unbox Diwali Sale" class="img-responsive " />
				</a>
			</div>
			<div class="cate_image_bg col-md-6 col-sm-6 col-xs-12" >
				<a href="/redirect?url=https%3A%2F%2Fwww.snapdeal.com%2Fproduct%2Fredmi-note3-32gb%2F654134757432%3Futm_source%3Daff_prog%26utm_campaign%3Dafts%26offer_id%3D17%26aff_id%3D19215%26sort%3Drlvncy" target="_blank">
					<img src="<?=asset("/images/v1/banners/banner_89.jpg")?>" alt="Ethnicals" class="img-responsive" />
				</a>
			</div>
<!--------------------------Recently Viewed--------------------------- -->
