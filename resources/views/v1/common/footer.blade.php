			...
			<div class="container">
                <div class="row">
                    ...
                    <div class="footer-block col-xs-12 col-sm-3 col-md-2">
                        ...
                        <ul class="toggle-footer">
                            <li class="item-footer">
                                <a href="<?=newUrl('mobile/smartphones')?>" title="Smartphone">Smartphone</a>
                            </li>                          					
							<li class="item-footer">                               
                                <a href="<?=newUrl('mobile/dual-sim-phones')?>" title="Dual Sim Mobiles">Dual Sim Mobiles</a>
                            </li>														
							<li class="item-footer">                               
                                <a href="<?=newUrl('mobile/android-phones')?>" title="Android Phones">Android Phones</a>
                            </li>							
							<li class="item-footer">                               
                                <a href="<?=newUrl('mobile/windows-phones')?>" title="Windows Phones">Windows Phones</a>
                            </li>
                        </ul>                            
                    ...
                    <div class="footer-block col-xs-12 col-sm-3 col-md-2">
                        <h4>About</h4>
							<ul class="toggle-footer">
                                ...
                                <li class="item-footer">
                                    <a href="<?=newUrl('blog')?>" title="Contact us">Blog</a>
                                </li>
                            </ul>
                    </div>
            ...
            <div class="footer_bottom">
                <div class="container">
                    ...
                    <div class="sitemap" style="float:right; margin-top:10px;">
                        <p><a href='<?php echo url('/all-categories'); ?>' style="color: #fff;" target="_blank">Sitemap</a></p>
                    </div>
                </div>
            </div>
    </footer>
...
<script type="text/javascript" src="<?=newUrl('js/v1/jquery.lazyload.min.js')?>"></script>
