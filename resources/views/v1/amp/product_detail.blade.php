...
@include("v1.meta.structure_data",[ 'product' => $product ])
...
.description-list{ width:100%; margin:0px; text-align:left; height:120px; overflow-y:scroll;overflow-x:none;}
...
.contentbott{font-size:14px; color:#000; padding: 0px 6px 0px 10px; text-transform:uppercase;}
...
.viewedbox{margin:0 auto; text-align:center; border:1px solid #e4e4e4; width:200px; overflow:hidden; padding:5px; height:246px;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;}
...
<!--END-HEADER-->
{!! Breadcrumbs::render("p_detail_amp",$product) !!}
<!--THE-MOBILE-SLIDE-->
...
<div class="container">
  <div class="shoppingsitelogo">
    <amp-img src="<?=config('vendor.vend_logo.'.$product->vendor )?>" width="80" height="30" alt="<?=config('vendor.name.'.$product->vendor )?>"/>
  </div>
  <div class="mobilename"><?=$product->name; ?></div>
  <div class="product-detail-price">
    <ul>
     <!-- <li><a href="#"><i class="fa fa-bell"></i> Set Price Alert</a></li>
      <li><a href="#"><i class="fa fa-retweet"></i> Add to compare</a></li>-->
      <li><a href="#"><i class="fa fa-star-o starcolor" aria-hidden="true"></i> <i class="fa fa-star-o starcolor" aria-hidden="true"></i> <i class="fa fa-star-o starcolor" aria-hidden="true"></i> <i class="fa fa-star-o" aria-hidden="true"></i> <i class="fa fa-star-o" aria-hidden="true"></i></a></li>
    </ul>
  </div>
  <div class="lowestprice">Lowest Price <span>Rs. <?=number_format($product->saleprice); ?></span></div>
  <a href="<?=$product->product_url?>" target="_blank" class="buy-nowbut">
...
@if(isset($product->description) && !empty($product->description))
  <div class="descriptionbox">
    ...
    <div class="description-list">
      <ul>
        <?php echo amp_desc_1( $product->description );?>
      </ul>
    </div>
  </div>
@endif
  ...
  ?>
    <div class="viewedbox">
      <div class="mobilenamecat">
       <a href="<?=$target_url?>" title="<?php echo clean($viewpro2->name); ?>" >
        <amp-img class="product_img" src="<?=getImage($viewpro2->image_url,$viewpro2->vendor,'M')?>" width="108" height="180" alt="<?php echo clean($viewpro2->name); ?>"/>
       </a>
      </div>
      <a href="<?=$target_url?>" title="<?php echo clean($viewpro2->name); ?>" class="detailstextmobile"><?php echo ($viewpro2->name); ?></a>
