...
Route::get('/list-of-{group}-{category}/{keyword}/{page?}/{order_by?}/{sort_order?}', [ 'as' => 'list_of_men_women', 'uses' => 'CustomLinksController@list_of_men_women' ] )->where(array('page'=>'[0-9]+'));

/******************************Valentine Day****************************************************/
Route::get('/romantic-february-valentines-special', 'ValentineController@index');
Route::get('/{day_name}-day-gifts-ideas-online/{page?}', 'ValentineController@day');
...
Route::get('product/{name}/{id}-{vendor}/amp', 'ProductController@product_detail_amp' ); //Product detail page non comparitive
Route::get('product/{name}/{id}', 'ProductController@product_detail_new' ); // Product detail page comparitive, mobiles etc
Route::get('product/{name}/{id}/amp', 'ProductController@product_detail_new_amp' ); // Product detail page comparitive, mobiles etc
