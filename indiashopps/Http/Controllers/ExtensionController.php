...
class ExtensionController extends Controller 
{
	...
	*/
	public function login( $provider )
	{
		...
		try
		{
			...
			//If user is Authenticated, then information will be fetch, or will be redirected to facebook/google for login.
			$social 	= $hybridauth->authenticate( $provider );
			$user 		= $social->getUserProfile();
	...
	*/
	public function processAuth()
	{
		...
		require_once( $library."/hybridauth/hybridauth/Hybrid/Auth.php" );
		require_once( $library."/hybridauth/hybridauth/Hybrid/Endpoint.php" );
